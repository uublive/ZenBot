...
var db = new sqlite3.Database('/Users/Tibi/Desktop/zenbot-local/quisquilia_db');

/*exports.connect = function()
{
	var db = new sqlite3.Database('/Users/Tibi/Desktop/ZenBot-master/quisquilia_db');
	return db;
};*/
 ...
 */
exports.getGreeting = function(player, callback) {
	var query   = "SELECT greeting FROM seen WHERE UPPER(player) = '" + player.toUpperCase() + "'";
	var greet = "";
	db.get(query, function(err, row) {
		if (row !== null && row !== undefined) {
			greet = row.greeting;
...
*@param {function} callback [description]
*/
exports.setGreeting = function(player, greeting, callback) {
	var query = "UPDATE seen SET greeting = '" + greeting + "' WHERE UPPER(player) = '" + player.toUpperCase() + "'";
	var message = "";
	if (greeting.length > 0) {
		db.run(query);
		message = "Your greeting has been set.";
		callback(message);
	}
	else {
		var query = "SELECT greeting FROM seen WHERE UPPER(player) = '" + player.toUpperCase() + "'";
...
*@param {function} callback [description]
*/
exports.removeGreeting = function(player, callback) {
	var query = "UPDATE seen SET greeting = '' WHERE UPPER(player) = '" + player.toUpperCase() + "'";
	var message = "";
	db.run(query);
