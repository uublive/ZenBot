...
var db = new sqlite3.Database('/home/ubuntu/zenbot/quisquilia_db');

/*exports.connect = function()
{
	var db = new sqlite3.Database('/home/ubuntu/bot/quisquilia_db');	
	return db;
}*/
...
exports.create = function()
{
	...
	// Seen
	db.run("CREATE TABLE IF NOT EXISTS seen (id INTEGER PRIMARY KEY AUTOINCREMENT, player TEXT, account TEXT, conference TEXT, date TEXT, global INTEGER, is_online INTEGER)");
...
{
	var game_id = null;
	//db.get("SELECT id FROM game WHERE creator = '" + creator + "' and conference = '" + conference + "' and active = 1", function(err, row) 
...
{ 
	...
	db.get(query, function(err, row) 
	{
		if(row != null) callback(row.global);
		else callback(null);
	});
}
