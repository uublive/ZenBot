 ...
 * @type {String}
 */
exports.ADMINS									= "an average buu, Estop Revolt, sum27039554@pvp.net";
 ...
 * @type {String}
 */
exports.RIOT_KEY								= "7cf36481-98b4-42d7-9dc3-b32ae600481c";
...
exports.COMMAND_HELP_DESCRIPTION				+= "" + "!"+this.COMMAND_HELP + ", " + "!"+this.COMMAND_LISTGAMES + ", " + "!"+this.COMMAND_SEEN + ", " + "!"+this.COMMAND_CANCELGAME + ", "  + "!"+this.COMMAND_GLOBAL + ", "  + "!"+this.COMMAND_INV + ", " + "!"+this.COMMAND_STATS + "\n\n"; 
