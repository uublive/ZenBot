...
(function() {
  ...
  RTMPClient = (function(_super) {
    ...
    function RTMPClient(client) {
      var _this = this;
      this.lolclient = client;
      this.socket = client.stream;
    ...
    RTMPClient.prototype.send = function(cmd, cb) {
      ...
      restart = function() {
        ...
        //return _this.lolclient.connect();
        if (!_this.broken){

          _this.broken = true;
          _this.socket.destroy();
          _this.lolclient.emit('restart');
        }
      ...
      closeSocket = function() {
        ...
        console.log('Timeout reached, Restarting.');
        _this.lolclient.connect;
        if (!_this.broken) {
          _this.broken = true;
          _this.socket.destroy();
        }
